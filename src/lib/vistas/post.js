...
export const post = () => {
  ...
  <div class="tarjeta sombra">
            <div class="tarjeta-encabezado">
                <h2>Tarjeta sencilla</h2>
            </div>
            <div class="tarjeta-cuerpo">
                <p>
                    Lorem ipsum dolor sit amet consectetur, adipisicing
                    elit. Blanditiis enim quibusdam sint ipsum sed
                    veniam? Quibusdam eligendi dolore sint, laboriosam
                    voluptas unde voluptates odio nulla autem dicta
                    provident soluta praesentium?
                </p>
            </div>
            <div class="tarjeta-acciones">
                <div>
