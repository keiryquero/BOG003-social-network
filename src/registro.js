  ...
  const templateRegistro = `
      ...
      <div class="contenedor-form">
       ...
       <p>Registrate con tu correo:</p><br>
        ...
        <input type="text" class="form" id="nombres" value="" placeholder="Nombre" required><br>
        <input type="email" class="form" id="email-registro" value="" placeholder="Email" required><br>
        <input type= "password" class="form" id="password-one" value="" placeholder="Password" required><br>
        <p>Acepto <a href="#">terminos y condiciones</a></p><br><br>
